...
""" Defines a wizard for import PSAT data files """
...
#------------------------------------------------------------------------------
#  "PSATImportPage" class:
#------------------------------------------------------------------------------

class PSATImportPage(FileImportPage):
    """ Defines a wizard page for PSAT data file selection """

    file_type = Str("PSAT")

    data_file = File(
        exists=True, filter=["PSAT Files (*.m)|*.m", "All Files|*.*"]
    )

#------------------------------------------------------------------------------
#  "PSATImportWizard" class:
#------------------------------------------------------------------------------

class PSATImportWizard(SimpleWizard):
    """ Defines a wizard for importing a PSAT data file """

    # The dialog title
    title = Str("Import PSAT")
