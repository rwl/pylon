...
#------------------------------------------------------------------------------
#  "M3ImportWizardExtension" class:
#------------------------------------------------------------------------------

class M3ImportWizardExtension(WizardExtension):
    """ Contributes a M3 import wizard.
    """

    # The wizard contribution's globally unique identifier.
    id = "pylon.plugin.readwrite.m3.import_wizard"

    # Human readable identifier
    name = "M3"

    # The wizards's image (displayed on selection etc)
    image = ImageResource("m3")

    # The class of contributed wizard
    wizard_class = "pylon.plugin.readwrite.m3.m3_import_wizard:" \
        "M3ImportWizard"

    # A longer description of the wizard's function
    description = "Import a M3 data file"
