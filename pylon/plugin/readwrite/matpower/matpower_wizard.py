...
class MATPOWERImportWizardExtension(WizardExtension):
    ...
    id = "pylon.plugin.readwrite.matpower.import_wizard"
    ...
    wizard_class = "pylon.plugin.readwrite.matpower.matpower_import_wizard:" \
...
class MATPOWERExportWizardExtension(WizardExtension):
    ...
    """
    # The wizard contribution's globally unique identifier.
    id = "pylon.plugin.readwrite.matpower.export_wizard"
    ...
    # The class of contributed wizard
    wizard_class = "pylon.plugin.readwrite.matpower.matpower_export_wizard:" \
