...
""" Actions that may be performed in a MarketEnvironment """
...
class MarketAction(HasTraits):
    """ A base class for actions that may be performed in
    a MarketEnvironment
