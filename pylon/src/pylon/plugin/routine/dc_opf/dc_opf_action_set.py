...
""" An action set for the DC OPF plug-in """
...
#------------------------------------------------------------------------------
#  "DCOPFActionSet" class:
#------------------------------------------------------------------------------

class DCOPFActionSet(WorkbenchActionSet):
    """ An action set for the DC OPF routine """
    ...
    id = "pylon.plugin.routine.dc_opf.action_set"
