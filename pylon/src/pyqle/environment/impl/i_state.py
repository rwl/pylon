...
from enthought.traits.api import Interface, Any, Instance, Int
...
class IState(Interface):
    ...
    environment = Instance(
        "pylon.pyreto.environment.impl.ienvironment.IEnvironment",
        allow_none=False
    )
    ...
    def __eq__(self, o):
        """
        It is up to the programmer to define when two states are declared
        equal
