...
class LorenzUIPlugin(Plugin):
    ...
    id = 'enthought.plugins.lorenz.ui'
    ...
    def _create_data_view(self, **traits):
        ...
        from enthought.plugins.lorenz.lorenz import DataView, Lorenz
    ...
    def _create_plot2d_view(self, **traits):
        ...
        from enthought.plugins.lorenz.lorenz import Lorenz, Plot2DView
